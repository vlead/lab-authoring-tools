...
- http://chemcollective.org/vlab/

** Features

- Online lab, to carry out chemistry experiments

- Has a library of items. Items interact with set of other items

- 
* Implementation in Javascript Documentation
